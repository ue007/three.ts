...
const directionalLightFolder = gui.addFolder('THREE.DirectionalLight.Position');
...
const directionalLightTargetFolder = gui.addFolder(
  'THREE.DirectionalLight.Target'
);
directionalLightTargetFolder.add(light.target.position, 'x', -100, 100, 0.01);
directionalLightTargetFolder.add(light.target.position, 'y', -100, 100, 0.01);
directionalLightTargetFolder.add(light.target.position, 'z', -100, 100, 0.01);
directionalLightTargetFolder.open();
