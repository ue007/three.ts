...
class App {
  ...
  private gl = require('gl')(this.width, this.height, {
  ...
  constructor(port: number) {
    ...
    const data = fs.readFileSync(
      path.resolve(__dirname, 'models/seanwasere.obj'),
    ...
    if (Object.keys(this.clients).length > 0) {
      ...
      new Jimp(this.width, this.height, (err: object, image: any) => {
        ...
        image.print(
          ...
          40,
          330,
          'Server ISO Date : ' + this.serverDateTime.toISOString()
        );
        image.print(
          this.font,
          40,
        ...
        image.print(
          ...
          40,
          370,
          'Client Count: ' + Object.keys(this.clients).length
        );
